...
int main()
{
	...
	*/
	...
	std::cout << solver.getStateAndTime(SolverIF::SOLVER_TYPES::RUNGE_KUTTA_FOUR, .001).getState()[0] << "\t" << solver.getStateAndTime(SolverIF::SOLVER_TYPES::RUNGE_KUTTA_FOUR, .001).getParams().totalError << "\n";
